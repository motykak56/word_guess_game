...
var smartAnimals= ["dolphin", "elephant", "dog", "cat", "squirrel", "chimpanzee","goat", 
"crow", "pig", "bee"];
...
function startGame() {
  ...
  // Solution chosen randomly from smartAnimals.
  chosenWord = smartAnimals[Math.floor(Math.random() * smartAnimals.length)];
